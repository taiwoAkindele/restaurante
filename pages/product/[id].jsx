...
const Product = () => {
    ...
    const pizza = {
        ...
        desc: "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minima esse enim error magnam voluptatem quam illum id laudantium. Natus, facere."
    }
  return (
    <div className={styles.container}>
         ...
         <div className={styles.right}>
            ...
            <div className={styles.size} onClick={()=>setSize(0)}>
                <Image src="/img/size.png" alt="medium-size" layout="fill" />
